...
//#region src/assets/icons/socials/mastodon.svg
var mastodon_default = createSvgComponent({
	"meta": {
		"src": "/_astro/mastodon.CYEHaaAQ.svg",
		"width": 24,
		"height": 24,
		"format": "svg"
	},
