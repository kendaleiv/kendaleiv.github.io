...
Original article media and downloads retain their `/assets/` paths. The site retains the original KD favicon and, without upstream's demo social image, uses AstroPaper's generated `/og.png`.
