...
Eventual consistency itself isn't terribly complex or difficult to understand. But, it _can_ be scary when implemented in ways that do not meet with user expectations. **Users looking at data and seeing their changes not reflected can cause alarm.** Developers should consider what users will see and do immediately after editing data in an application or website utilizing eventual consistency to avoid confusion and panic.
