...
slug: operating-a-wi-fi-enabled-robot-vacuum-mop-during-a-home-internet-outage-using-a-smartphone-hotspot
...
1. Turn off the existing Wi-Fi network _(to avoid confusion with your phone hotspot network)_.
...
If you're having trouble try waiting a bit if it needs to find the hotspot network. If it's still not working check the hotspot settings. Ensure you're using a supported Wi-Fi band _(try 2.4 GHz if other options are unsupported by your device)_.
