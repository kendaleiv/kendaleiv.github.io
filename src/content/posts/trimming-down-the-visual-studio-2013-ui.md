...
- First, reset your settings with the **Web Development (Code Only)** settings.
  - Tools -> Import and Export Settings... -> Reset all settings -> No, just reset settings, overwriting my current settings _(or, save your existing settings if you'd like...)_ -> **Web Development (Code Only)**
