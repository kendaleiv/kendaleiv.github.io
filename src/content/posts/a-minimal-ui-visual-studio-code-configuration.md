...
![Visual Studio Code default interface](@/assets/images/a-minimal-ui-visual-studio-code-configuration/1.png)

to this:

![Visual Studio Code minimal interface](@/assets/images/a-minimal-ui-visual-studio-code-configuration/2.png)
